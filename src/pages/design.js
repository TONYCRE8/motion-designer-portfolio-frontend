  ...
  return (
    <div className="flex justify-center items-center flex-col">
      <SEO 
        ...
        pathSlug="design/"
      />
      <h1 className="text-4xl md:my-4 my-2 mt-16">Design Works</h1>
      <p className="text-center">Either conceptual or designs that become eventual development projects, they're all documented here.</p>
        ...
        {data.map(project => (
          <Link to={"/design/" + project.slug} key={project.id} className="project opacity-0 flex flex-col relative w-80 h-48 max-w-sm mx-2 shadow-md my-4 hover:scale-105 transform duration-150">
            ...
            <div className="absolute h-full w-full">
              <img className="h-full w-full object-cover object-top" src={project.thumbnail.formats.medium.url} alt={project.thumbnail.alternativeText}/>
            </div>
          </Link>
        ))}
      </ul>
